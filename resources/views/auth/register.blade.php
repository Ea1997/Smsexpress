                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row">
                                <label for="Pname" class="col-md-4 col-form-label text-md-right">{{ __('Prenom') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="telephone" class="col-md-4 col-form-label text-md-right">{{ __('Numéro de télephone') }}</label>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="CIN" type="text" class="form-control @error('CIN') is-invalid @enderror" name="CIN" value="{{ old('CIN') }}"  autocomplete="CIN" autofocus>
